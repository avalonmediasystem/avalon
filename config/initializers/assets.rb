...
Rails.application.config.assets.precompile += %w( jquery.xmleditor.css )
Rails.application.config.assets.precompile += %w( xmleditor/jquery.xmleditor.js )
Rails.application.config.assets.precompile += %w( xmleditor/xsd2json.js )
