    ...
    config[:submission_workflow] = {
        :videos =>           [{:name => "contributor",     :edit_partial => "videos/contributor_form",     :show_partial => "videos/show_contributors"},
			      ...
			      {:name => "video_files",     :edit_partial => "video_assets/video_assets_form",   :show_partial => "videos/show_video_assets"},
                              {:name => "permissions",     :edit_partial => "hydra/permissions/permissions_form",     :show_partial => "videos/show_permissions"}
                             ],
        ...
        :generic_contents => [{:name => "description", :edit_partial => "generic_content_objects/description_form", :show_partial => "generic_contents/show_description"},
                              {:name => "files",       :edit_partial => "hydra/file_assets/file_assets_form",             :show_partial => "hydra/file_assets/index"},
