...
Rails.application.config.to_prepare do
  begin
    ...
    Sidekiq::Cron::Job.create(name: 'Status Checking and Email Notification of Existing Batches - every 1min', cron: '*/1 * * * *', class: 'IngestBatchStatusEmailJobs::IngestFinished')
