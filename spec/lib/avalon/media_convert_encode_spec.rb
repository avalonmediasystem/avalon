...
describe MediaConvertEncode do
  ...
  describe 'create' do
    context 'with audio' do
      ...
      it 'sets the outputs' do
        ...
        expect(create_outputs).to include(hash_including("preset", "modifier" => 'quality-high'), hash_including("preset", "modifier" => 'quality-medium'))
      end
    end
    ...
    context 'with video' do
      ...
      it 'sets the outputs' do
        ...
        expect(create_outputs).to include(hash_including("preset", "modifier" => 'quality-high'), hash_including("preset", "modifier" => 'quality-medium'), hash_including("preset", "modifier" => 'quality-low'))
      end
    end
