...
module ApplicationHelper
  ...
  def image_for(document)
    ...
    video_count = document["avalon_resouece_type_sim"].count{|m| m.start_with?('moving image') } rescue 0
    audio_count = document["avalon_resouece_type_sim"].count{|m| m.start_with?('sound recording') } rescue 0
