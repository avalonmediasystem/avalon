...
Object.assign(MediaElementPlayer.prototype, {
  ...
  buildhdToggle(player, controls, layers, media) {
    const t = this;
    const hdToggleText = mejs.Utils.isString(t.options.hdToggleText) ? t.options.hdToggleText : mejs.i18n.t('mejs.hd-toggle')
    player.qualities = [];
    ...
    player.hdtoggleButton.addEventListener(
      'click',
      t.toggleQuality.bind(t)
    );
