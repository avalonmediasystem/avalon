  ...
  def paged_index
    ...
    response = {
      ...
      "data": @playlists.collect do |playlist|
        ...
        delete_button = view_context.link_to(playlist_path(playlist), method: :delete, class: 'btn btn-sm btn-danger btn-confirmation', data: {placement: 'bottom', testid: 'deleteTableView'}) do
